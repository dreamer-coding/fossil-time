...
FOSSIL_TEST_GROUP(c_span_tests) {
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_clear);
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_validate);
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_normalize);
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_from_unit);
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_from_ai);
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_add_sub);
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_to_seconds);
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_to_nanoseconds);
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_format);
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_format_buffer_small);
    FOSSIL_ADD_TEST(c_span_suite, c_test_span_format_nulls);

    FOSSIL_ADD_SUITE(c_span_suite);
}
